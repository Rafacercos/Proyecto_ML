...
if menu == "Inicio":
    ...
    with col1:
        ...
        educacion = st.selectbox("Nivel educativo", [
            ...
            "Estudios universitarios", "Asociado académico", "Asociado técnico", 
            "Licenciatura", "Máster", "Doctorado", "Formación profesional"])
    with col2:
    ...
    educ_map = {
         "Guardería": 1, "1st-4th": 2, "5th-6th": 3, "7th-8th": 4, "9th": 5,
            ...
            "Estudios universitarios": 10, "Asociado académico": 11, "Asociado técnico": 12, 
            "Licenciatura": 13, "Máster": 14, "Doctorado": 16, "Formación profesional": 15
    }
